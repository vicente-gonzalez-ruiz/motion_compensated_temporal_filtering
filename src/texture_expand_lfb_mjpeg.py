...
## @file texture_expand_lfb_mjpeg.py
#  Expand the LFB texture data, using Motion JPEG.
...
## @package texture_expand_lfb_mjpeg
#  Expand the LFB texture data, using Motion JPEG.
#  The two main steps performed are:
#  - Decode components.
#  - Transforms a YUV file to Raw file.
...
def usage():
    sys.stderr.write("+-------------------------------+\n")
    sys.stderr.write("| MCTF texture_expand_lfb_mjpeg |\n")
    sys.stderr.write("+-------------------------------+\n")
    sys.stderr.write("\n")
