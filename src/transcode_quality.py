...
# subband-layer will contribute with the same quality to the
# corresponding temporal subband.
#
# Each temporal subband contribute with a different of energy
# (~quality) to the reconstruction of the GOP. For example, if L1 is
# 1.25 times more energetic than H1, each subband-layer of L1 also
# will contribute 1.25 times more than any other layer of H1.
#
# The size of each subband-layer in each subband has a different
# length. If 1 is the length of L1.l3 and H1.l3 (supposing 4
# subband-layers), \sqrt(2) will be the length (on average) of L1.l2
...
# 1.25 times lower than the lengths of the subband-layers of H1. So,
