...
class Defaults():
    ...
    resolution_FHD       = 1920 * 1080 ## Refers to Full-HD resolution. Is used as a boundary between the use of a block size of 16 or 32 by default.
    pixels_in_x          = 352         ## Width of the pictures.
    pixels_in_y          = 288         ## Height of the pictures.
    always_B             = 0           ## Forces to use only B frames.
    block_overlaping     = 0           ## Number of overlaped pixels between the blocks in the motion compensation process.
    block_size           = 32          ## Size of the blocks in the motion estimation process.
